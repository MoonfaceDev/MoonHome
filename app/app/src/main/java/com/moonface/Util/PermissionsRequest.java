...
public class PermissionsRequest {
    ...
    private HashMap<String, Boolean> resultList;
    private String[] requestsList;
    private int requestsCode = 6;
    private ArrayList<String> tempList;
    private Activity activity;
    public PermissionsRequest(Activity activity, String[] permissions) {
    ...
    public void filterPermissionsList() {
        ...
        requestsList = new String[tempList.size()];
        for (int i = 0; i < tempList.size(); i++) {
            requestsList[i] = tempList.get(i);
        }
    }
    ...
    public void showRequest() {
        if(requestsList!=null) {
            if (requestsList.length > 0) {
                ActivityCompat.requestPermissions(activity, requestsList, requestsCode);
            }
        } else {
            if (permissionsList.length > 0) {
                ActivityCompat.requestPermissions(activity, permissionsList, requestsCode);
            }
        }
    }
}
