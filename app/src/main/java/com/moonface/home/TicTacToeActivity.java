...
public class TicTacToeActivity extends AppCompatActivity {
    ...
    private void initializeLogic() {
        ...
        GradientDrawable buttonLy = new GradientDrawable();  buttonLy.setColor(0xFF37474F);  buttonLy.setCornerRadius(30);
        ...
        GradientDrawable linearLz = new GradientDrawable();  linearLz.setColor(0xFF37474F);  linearLz.setCornerRadius(0);
        ...
        linear14.setLayoutParams(params);
        int buttonHeight = screenWidth / 8;
        LinearLayout.LayoutParams params2 = new LinearLayout.LayoutParams(boardWidth, buttonHeight);
        params2.setMargins(0,0,0,buttonHeight/2);
        button2.setLayoutParams(params2);
        int cellWidth = screenWidth /4;
        LinearLayout.LayoutParams params1 = new LinearLayout.LayoutParams(cellWidth,cellWidth);
        imageview_1.setLayoutParams(params1);
        imageview_2.setLayoutParams(params1);
        imageview_3.setLayoutParams(params1);
        imageview_4.setLayoutParams(params1);
        imageview_5.setLayoutParams(params1);
        imageview_6.setLayoutParams(params1);
        imageview_7.setLayoutParams(params1);
        imageview_8.setLayoutParams(params1);
        imageview_9.setLayoutParams(params1);
        imageview_1.setBackground(getResources().getDrawable(R.drawable.tic_tac_toe_cell));
        imageview_2.setBackground(getResources().getDrawable(R.drawable.tic_tac_toe_cell));
        imageview_3.setBackground(getResources().getDrawable(R.drawable.tic_tac_toe_cell));
        imageview_4.setBackground(getResources().getDrawable(R.drawable.tic_tac_toe_cell));
        imageview_5.setBackground(getResources().getDrawable(R.drawable.tic_tac_toe_cell));
        imageview_6.setBackground(getResources().getDrawable(R.drawable.tic_tac_toe_cell));
        imageview_7.setBackground(getResources().getDrawable(R.drawable.tic_tac_toe_cell));
        imageview_8.setBackground(getResources().getDrawable(R.drawable.tic_tac_toe_cell));
        imageview_9.setBackground(getResources().getDrawable(R.drawable.tic_tac_toe_cell));
    }
